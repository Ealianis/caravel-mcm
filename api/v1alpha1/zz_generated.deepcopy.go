...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ManagedClusterSpec) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemeberClusterLease) DeepCopyInto(out *MemeberClusterLease) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemeberClusterLease.
func (in *MemeberClusterLease) DeepCopy() *MemeberClusterLease {
	if in == nil {
		return nil
	}
	out := new(MemeberClusterLease)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MemeberClusterLease) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemeberClusterLeaseList) DeepCopyInto(out *MemeberClusterLeaseList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]MemeberClusterLease, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemeberClusterLeaseList.
func (in *MemeberClusterLeaseList) DeepCopy() *MemeberClusterLeaseList {
	if in == nil {
		return nil
	}
	out := new(MemeberClusterLeaseList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MemeberClusterLeaseList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemeberClusterLeaseSpec) DeepCopyInto(out *MemeberClusterLeaseSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemeberClusterLeaseSpec.
func (in *MemeberClusterLeaseSpec) DeepCopy() *MemeberClusterLeaseSpec {
	if in == nil {
		return nil
	}
	out := new(MemeberClusterLeaseSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemeberClusterLeaseStatus) DeepCopyInto(out *MemeberClusterLeaseStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemeberClusterLeaseStatus.
func (in *MemeberClusterLeaseStatus) DeepCopy() *MemeberClusterLeaseStatus {
	if in == nil {
		return nil
	}
	out := new(MemeberClusterLeaseStatus)
	in.DeepCopyInto(out)
	return out
}
